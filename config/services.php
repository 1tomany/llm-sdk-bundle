...
return static function (ContainerConfigurator $container): void {
    $container
        ->services()
            ...
            // File Clients
            ->set('1tomany.llmsdk.client.claude.file', ClaudeFileClient::class)
                ->tag('1tomany.llmsdk.client.file')
            ->set('1tomany.llmsdk.client.gemini.file', GeminiFileClient::class)
                ->tag('1tomany.llmsdk.client.file')
            ->set('1tomany.llmsdk.client.mock.file', MockFileClient::class)
                ->tag('1tomany.llmsdk.client.file')
            ->set('1tomany.llmsdk.client.openai.file', OpenAIFileClient::class)
                ->tag('1tomany.llmsdk.client.file')

            // Query Actions
            ->alias(CompileQueryActionInterface::class, service('1tomany.llmsdk.action.query.compile'))
            ->alias(ExecuteQueryActionInterface::class, service('1tomany.llmsdk.action.query.execute'))
            ->set('1tomany.llmsdk.action.query.compile', CompileQueryAction::class)
                ->arg('$clientFactory', service('1tomany.llmsdk.factory.client.query'))
            ->set('1tomany.llmsdk.action.query.execute', ExecuteQueryAction::class)
                ->arg('$clientFactory', service('1tomany.llmsdk.factory.client.query'))

            // Query Clients
            ->set('1tomany.llmsdk.client.gemini.query', GeminiQueryClient::class)
                ->tag('1tomany.llmsdk.client.query')
            ->set('1tomany.llmsdk.client.mock.query', MockQueryClient::class)
                ->tag('1tomany.llmsdk.client.query')
            ->set('1tomany.llmsdk.client.openai.query', OpenAIQueryClient::class)
                ->tag('1tomany.llmsdk.client.query')
    ;
};
